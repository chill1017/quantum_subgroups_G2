...
\begin{definition}\label{def:D4}
    ...
    % \begin{equation*}
    % \omega = -1, \quad a = 1, \quad b = -1
    % \end{equation*}
    \begin{equation*}
        \skein{/skein_figs/swap_LHS}{0.15} = - \skein{/skein_figs/swap_RHS}{0.15}, \qquad
        \skein{/skein_figs/stick_w_Pg}{0.25} = \skein{/skein_figs/stick}{0.1}, \qquad
        \skein{/skein_figs/g_bigon2}{0.1} = b \skein{/skein_figs/stick}{0.15}
    \end{equation*}
    ...
    % \end{equation*}
    \begin{equation*}
        \skein{/skein_figs/leftUp}{0.1} =  q^{-4} \skein{/skein_figs/trivalent}{0.13} + q^{16} \skein{/skein_figs/rightUp}{0.1}
    \end{equation*}
    ...
    \begin{equation*}
        \skein{/skein_figs/trigon_singly}{0.1} = -\skein{/skein_figs/trivalent}{0.13} -\skein{/skein_figs/rightUp}{0.1}
    \end{equation*}

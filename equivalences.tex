...
It is necessary to note that from [\red{TODO}] we know that the only nontrivial Etale algebras 
...
\begin{proof}[Proof of Theorem~\ref{thm:level-4}]
    ...
    \]
    Now let us chase $1$ along the top leftmost path to demonstrate that this is not the case.
...
The category $\DD_3$, whose $\Z_3$-like structure constants are given in the attached Mathematica notebook,
admits an analogous theorem at level 3.

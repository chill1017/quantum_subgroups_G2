...
the idempotent whose role is played by $\skein{skein_figs/dec_tet_5}{0.08}$.
...
\blue{}
Table~\ref{tab:lvl-4-proj-coefs} holds the values of the nonzero projection coordinates;
in this table we set
\begin{equation*}
    \alpha = \frac{\sqrt{1+\sqrt{6-3 \sqrt{3}}}-\sqrt{\sqrt{2+\sqrt{3}}-1}}{\sqrt{2}}
\end{equation*}

\begin{equation*}
    \beta_1 = \sqrt{\sqrt{2+\sqrt{3}}-1}
\end{equation*}

\begin{equation*}
    \beta_2 = \sqrt{\sqrt{3}+\sqrt{2+\sqrt{3}}}
\end{equation*}

\begin{equation*}
    \beta_3 = \sqrt{2+\sqrt{2}-\sqrt{6}}
\end{equation*}

\begin{equation*}
    \lambda = 2 \sqrt{1+\sqrt{\frac{3}{2}}}
\end{equation*}

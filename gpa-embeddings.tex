...
A proof of the above result amounts to a verification of a system of linear, quadratic, cubic, quartic, and quintic equations.
Let 
\[
...
\end{theorem}
\begin{proof}
    See the attached Mathemaica notebooks for verification.
\end{proof}
